...
/**
 * An event that is fired on logical and physical servers when they are collecting their reload listeners. This event allows you to register your own reload listeners.
 */
