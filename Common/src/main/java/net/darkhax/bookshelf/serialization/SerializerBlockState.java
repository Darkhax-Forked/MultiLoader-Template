            ...
            if(propValue.isJsonPrimitive()) {
                ...
                if(parsedValue.isPresent()) {
                    ...
                    try {
                        ...
                        Bookshelf.LOG.error("Failed to update state for block {}. The mod that adds this block may have an issue.", Registry.BLOCK
                ...
                throw new JsonSyntaxException("Expected property value for " + propName + " to be primitive string. Got " + GsonHelper
                        .getType(propValue));
            }
        } else {
            
            throw new JsonSyntaxException("The property " + propName + " is not valid for block " + Registry.BLOCK.getId(state
                    .getBlock()));
        }
    }
